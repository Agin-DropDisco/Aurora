...
export function handleDistributionInitialization(event: Initialized): void {
  ...
  let factory = DexsStakingRewardsFactory.load(stakingRewardsFactoryAddress)
  if (factory === null) {
    factory = new DexsStakingRewardsFactory(stakingRewardsFactoryAddress)
...
export function handleDistributionCancelation(event: Canceled): void {
  // load factory (create if first distribution)
  let factory = DexsStakingRewardsFactory.load(getStakingRewardsFactoryAddress())
  if (factory === null) {
