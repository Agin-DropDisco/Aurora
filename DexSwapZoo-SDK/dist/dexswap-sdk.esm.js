...
import { mainnet, rinkeby, aurora, mumbai } from 'dexswap-core/.contracts.json';
import { mainnet as mainnet$1, rinkeby as rinkeby$1, aurora as aurora$1, mumbai as mumbai$1 } from 'dexswap-periphery/.contracts.json';
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = mainnet.factory, _FACTORY_ADDRESS[ChainId.RINKEBY] = rinkeby.factory, _FACTORY_ADDRESS[ChainId.AURORA] = aurora.factory, _FACTORY_ADDRESS[ChainId.MUMBAI] = mumbai.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.MAINNET] = mainnet$1.router, _ROUTER_ADDRESS[ChainId.RINKEBY] = rinkeby$1.router, _ROUTER_ADDRESS[ChainId.AURORA] = aurora$1.router, _ROUTER_ADDRESS[ChainId.MUMBAI] = mumbai$1.router, _ROUTER_ADDRESS);
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[ChainId.RINKEBY] = '0x709db16a6ef437197938256460c49183dc36ca4d', _STAKING_REWARDS_FACT[ChainId.AURORA] = '0xDc389aA3a4d16d1fa6826088323F11A796838020', _STAKING_REWARDS_FACT[ChainId.MUMBAI] = '0x5CC549EeFabFeD7aD69D9Cc637651d677ACE2256', _STAKING_REWARDS_FACT);
var INIT_CODE_HASH = '0xac17f607c2e91b3bbb92c2ffe17fe2775041d68f0c80032725189cc9943f262b';
...
Currency.AURORA = /*#__PURE__*/new Currency(18, 'AURORA', 'AURORA');
Currency.MATIC = /*#__PURE__*/new Currency(18, 'MATIC', 'MATIC');
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.AURORA] = Currency.AURORA, _Currency$NATIVE_CURR[ChainId.MUMBAI] = Currency.MATIC, _Currency$NATIVE_CURR);
var USD = Currency.USD;
var ETHER = Currency.ETHER;
var AURORA = Currency.AURORA;

var _Token$WETH, _Token$DexSwapZoo, _Token$WMATIC, _Token$NATIVE_CURRENC;
/**
...
Token.WETH = (_Token$WETH = {}, _Token$WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _Token$WETH[ChainId.RINKEBY] = /*#__PURE__*/new Token(ChainId.RINKEBY, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _Token$WETH[ChainId.AURORA] = /*#__PURE__*/new Token(ChainId.AURORA, '0x784e5B8541410284092cf465Cd455Beb09aAcdc3', 18, 'WAURORA', 'Wrapped Aurora'), _Token$WETH[ChainId.MUMBAI] = /*#__PURE__*/new Token(ChainId.MUMBAI, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'), _Token$WETH); // TODO:

Token.DexSwapZoo = (_Token$DexSwapZoo = {}, _Token$DexSwapZoo[ChainId.RINKEBY] = /*#__PURE__*/new Token(ChainId.RINKEBY, '0xA9c6d7F92a894310B9C04968326A9dE6D0e38724', 18, 'xDEXS', 'xDEXS'), _Token$DexSwapZoo[ChainId.AURORA] = /*#__PURE__*/new Token(ChainId.AURORA, '0x45e92Dd180ECa40f90556Aa5B84620F253194E5E', 18, 'DexSwapZoo', 'DEZU'), _Token$DexSwapZoo[ChainId.MUMBAI] = /*#__PURE__*/new Token(ChainId.MUMBAI, '0x4F80365e46da3A5B03458c31CccB3b640E12d4fE', 18, 'DexSwapZoo', 'DEZU'), _Token$DexSwapZoo);
Token.WMATIC = (_Token$WMATIC = {}, _Token$WMATIC[ChainId.MUMBAI] = /*#__PURE__*/new Token(ChainId.MUMBAI, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'), _Token$WMATIC);
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.AURORA] = Token.WETH[ChainId.AURORA], _Token$NATIVE_CURRENC[ChainId.MUMBAI] = Token.WMATIC[ChainId.MUMBAI], _Token$NATIVE_CURRENC);
/**
...
var WETH = Token.WETH;
var DexSwapZoo = Token.DexSwapZoo;
...
var SUSHISWAP_FACTORY_ADDRESS = '0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac'; // MUMBAI

var QUICKSWAP_FACTORY_ADDRESS_TESTNET = '0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32'; //mumbai

var UNISWAP_ROUTER_ADDRESS = '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D';
var SUSHISWAP_ROUTER_ADDRESS = '0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F'; // MUMBAI

var QUICKSWAP_ROUTER_ADDRESS_TESTNET = '0x8954AfA98594b838bda56FE4C12a09D7739D179b'; // mumbai //
...
RoutablePlatform.QUICKSWAP = /*#__PURE__*/new RoutablePlatform('Quickswap', (_RoutablePlatform5 = {}, _RoutablePlatform5[ChainId.MUMBAI] = QUICKSWAP_FACTORY_ADDRESS_TESTNET, _RoutablePlatform5), (_RoutablePlatform6 = {}, _RoutablePlatform6[ChainId.MUMBAI] = QUICKSWAP_ROUTER_ADDRESS_TESTNET, _RoutablePlatform6), '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f', _30);

var _INITIAL_CACHE_STATE, _PAIR_ADDRESS_CACHE;
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[ChainId.AURORA] = {}, _INITIAL_CACHE_STATE[ChainId.MUMBAI] = {}, _INITIAL_CACHE_STATE[ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE);
...
var MINIMUM_STAKED_AMOUNT_NATIVE_CURRENCY = (_MINIMUM_STAKED_AMOUN = {}, _MINIMUM_STAKED_AMOUN[ChainId.RINKEBY] = /*#__PURE__*/CurrencyAmount.nativeCurrency( /*#__PURE__*/utils.parseUnits('0.05', Token.getNative(ChainId.RINKEBY).decimals).toString(), ChainId.RINKEBY), _MINIMUM_STAKED_AMOUN[ChainId.MAINNET] = /*#__PURE__*/CurrencyAmount.nativeCurrency( /*#__PURE__*/utils.parseUnits('0.1', Token.getNative(ChainId.MAINNET).decimals).toString(), ChainId.MAINNET), _MINIMUM_STAKED_AMOUN[ChainId.AURORA] = /*#__PURE__*/CurrencyAmount.nativeCurrency( /*#__PURE__*/utils.parseUnits('0.05', Token.getNative(ChainId.AURORA).decimals).toString(), ChainId.AURORA), _MINIMUM_STAKED_AMOUN[ChainId.MUMBAI] = /*#__PURE__*/CurrencyAmount.nativeCurrency( /*#__PURE__*/utils.parseUnits('0.05', Token.getNative(ChainId.MUMBAI).decimals).toString(), ChainId.MUMBAI), _MINIMUM_STAKED_AMOUN);
