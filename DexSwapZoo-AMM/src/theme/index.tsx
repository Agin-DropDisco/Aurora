...
#root {
  background-image: radial-gradient(80vw 100vh at 50vw 0vh,rgba(135,128,191,0.3) 0%,#191A24 100%);
  background: url(https://raw.githubusercontent.com/Agin-DropDisco/Grant-Harmony-Source/main/dexswapMain.png);
  background-repeat: no-repeat;
...
#algo {
  ...
  display: flex;
  padding: 0;
  -webkit-flex: 0 1 auto align-items:center;
  -ms-flex: 0 1 auto align-items:center;
...
#bridge-currency-input .pmTWa button {
...
.dexswap-pagination ul {
  display: inline-flex;
}

.dexswap-pagination li {
...
.dexswap-pagination li.rc-pagination-item-active {
  border: solid 1px ${props => props.theme.bg4};
}

.dexswap-pagination li.rc-pagination-prev,
.dexswap-pagination li.rc-pagination-next {
  color: ${props => props.theme.white};
  padding-top: 2px;
}

.dexswap-pagination li.rc-pagination-options {
  display: none;
}

.dexswap-pagination li.rc-pagination-disabled {
  border: solid 1px ${props => props.theme.bg3};
