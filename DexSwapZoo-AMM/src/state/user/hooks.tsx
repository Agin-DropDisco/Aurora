import { ChainId, Pair, Token } from 'dexswap-sdk'
 ...
 */
 export function toDexSwapLiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'DexSwapZoo', 'DexSwap')
}
