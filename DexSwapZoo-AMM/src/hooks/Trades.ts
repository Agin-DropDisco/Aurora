import { Currency, CurrencyAmount, Pair, RoutablePlatform, Token, Trade } from 'dexswap-sdk'
...
export function useTradeExactInAllPlatforms(
  ...
  const bestTrades = [
    useTradeExactIn(currencyAmountIn, currencyOut, RoutablePlatform.DEXSWAP),
...
export function useTradeExactOutAllPlatforms(
  ...
  const bestTrades = [
    useTradeExactOut(currencyIn, currencyAmountOut, RoutablePlatform.DEXSWAP),
