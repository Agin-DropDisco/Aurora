...
import DexswapGradient from '../../assets/svg/banner_bot.svg'
  ...
  function getModalContent() {
    ...
    return (
      <UpperSection>
        ...
        {/* TODO: */}
        <Blurb as="a" href="https://github.com/Agin-DropDisco" rel="noopener noreferrer" target="_blank">
          <TYPE.body fontWeight={700} fontSize="10px" color="text5" letterSpacing="3px" marginBottom="8px">
              DEXSWAP 
          </TYPE.body>
          ...
          <img src={DexswapGradient} alt="dexswap" />
        </Blurb>
      </UpperSection>
    )
  }
