import { ChainId, Currency, Token, DexSwapZoo } from 'dexswap-sdk'
import React, { ReactNode, useMemo } from 'react'
import Skeleton from 'react-loading-skeleton'
import styled from 'styled-components/macro'

import EthereumLogo from '../../assets/images/ethereum-logo.jpg'
import DexSwapZooLogo from '../../assets/images/zoodexblue.png'
import AuroraLogo from '../../assets/svg/aurora-white.svg';
import PolygonLogo from '../../assets/images/matic-logo.jpg'
...
const NATIVE_CURRENCY_LOGO: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA]: AuroraLogo,
  [ChainId.MUMBAI]: PolygonLogo,
...
export default function CurrencyLogo({
  ...
  const nativeCurrencyLogo = NATIVE_CURRENCY_LOGO[(chainId as ChainId) || ChainId.AURORA]
  ...
  const srcs: string[] = useMemo(() => {
    ...
    if (currency instanceof Token) {
      ...
      if (chainId && DexSwapZoo[chainId] && DexSwapZoo[chainId].address === currency.address) return [DexSwapZooLogo]
