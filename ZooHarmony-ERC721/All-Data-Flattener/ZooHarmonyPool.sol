...
// File: browser/IRewardDistributionRecipientflat.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.0/contracts/math/Math.sol
...
contract LPTokenWrapper {
    ...
    IERC20 public zooinlp = IERC20(0x96defb9fd5DDF75c502dEDadaf188F131B2A825f); // DexSwap ZOO/AURORA LP Token
    ...
    function stake(uint256 amount) public {
        ...
        zooinlp.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        zooinlp.safeTransfer(msg.sender, amount);
    }
}

contract ZooHarmonyPool is LPTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public zoo = IERC20(0xfe9ACf9f058c9324B7A6CE576e07485414b94B17); //ZOO ADDRESS
    
    uint256 public constant DURATION = 60 days; // 2 Month Pool Round Until Retired.
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            zoo.safeTransfer(msg.sender, reward);
