...
// File contracts/AuroraDigital.sol
pragma solidity ^0.8.0;


contract AuroraDigital is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721('Aurora Digital', 'ADL') {}
    ...
    function getPrice() public view returns(uint256) {
        ...
        if (totalSupply() < 1000) {
            ...
            price = (totalSupply() * 7 / 50 - 125) * 1 ether;
        }
    ...
    function mint(address to, string memory uri) internal {
        require(totalSupply() <= 10000, 'supply depleted');
    ...
    function buyMint(string memory uri) public payable {
        require(getPrice() <= msg.value, 'not enough paid!');
        mint(msg.sender, uri);
    }
    
    function payout() payable public onlyOwner {
        address payable AdminOne = payable(0xAd5104295Eedf7cd678387F18cb2da733F40E1be); //personal
        address payable AdminTwo = payable(0x9D541E5EC9e3FA7324A6d0b0530707b64D4953Df); //personal

        uint256 balance = address(this).balance;
        uint256 split = balance / 2;
        AdminOne.transfer(split);
        AdminTwo.transfer(split);
    }
